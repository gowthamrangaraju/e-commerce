 ...
 <div class="container-fluid">
                <div class="row-fluid" >
                    <div class="col-md-offset-4 col-md-4" id="box">
                      <h2>ORDER FORM</h2>
                         <hr>
                             <form class="form-horizontal" action="neworder" method="post" id="contact_form">
                                    <fieldset>
                                        <!-- Form Name -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input name="CustomerName" placeholder="CustomerName" class="form-control" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input name="phone" placeholder="PAYMENTMODE" class="form-control" type="text">
                                                </div>
                                            </div>
                                        </div>
